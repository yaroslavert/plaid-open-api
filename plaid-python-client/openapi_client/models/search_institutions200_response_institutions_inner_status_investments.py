...
class SearchInstitutions200ResponseInstitutionsInnerStatusInvestments(BaseModel):
    """
    SearchInstitutions200ResponseInstitutionsInnerStatusInvestments
    """ # noqa: E501
    status: Optional[StrictStr] = None
    last_status_change: Optional[datetime] = None
    breakdown: Optional[SearchInstitutions200ResponseInstitutionsInnerStatusInvestmentsBreakdown] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "breakdown": SearchInstitutions200ResponseInstitutionsInnerStatusInvestmentsBreakdown.from_dict(obj["breakdown"]) if obj.get("breakdown") is not None else None
        })
        return _obj
