...
class SearchInstitutions200ResponseInstitutionsInnerStatusItemLogins(BaseModel):
    """
    SearchInstitutions200ResponseInstitutionsInnerStatusItemLogins
    """ # noqa: E501
    status: Optional[StrictStr] = None
    last_status_change: Optional[datetime] = None
    breakdown: Optional[SearchInstitutions200ResponseInstitutionsInnerStatusItemLoginsBreakdown] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "breakdown": SearchInstitutions200ResponseInstitutionsInnerStatusItemLoginsBreakdown.from_dict(obj["breakdown"]) if obj.get("breakdown") is not None else None
        })
        return _obj
