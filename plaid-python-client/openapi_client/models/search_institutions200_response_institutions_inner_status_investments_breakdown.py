...
class SearchInstitutions200ResponseInstitutionsInnerStatusInvestmentsBreakdown(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["success", "error_plaid", "error_institution"]
