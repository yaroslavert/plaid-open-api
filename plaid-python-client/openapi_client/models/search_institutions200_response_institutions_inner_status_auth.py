...
class SearchInstitutions200ResponseInstitutionsInnerStatusAuth(BaseModel):
    """
    SearchInstitutions200ResponseInstitutionsInnerStatusAuth
    """ # noqa: E501
    status: Optional[StrictStr] = None
    last_status_change: Optional[datetime] = None
    breakdown: Optional[SearchInstitutions200ResponseInstitutionsInnerStatusAuthBreakdown] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "breakdown": SearchInstitutions200ResponseInstitutionsInnerStatusAuthBreakdown.from_dict(obj["breakdown"]) if obj.get("breakdown") is not None else None
        })
        return _obj
