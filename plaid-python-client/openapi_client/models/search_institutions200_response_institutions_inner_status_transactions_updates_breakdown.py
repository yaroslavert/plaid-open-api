...
class SearchInstitutions200ResponseInstitutionsInnerStatusTransactionsUpdatesBreakdown(BaseModel):
    """
    SearchInstitutions200ResponseInstitutionsInnerStatusTransactionsUpdatesBreakdown
    """ # noqa: E501
    success: Optional[Union[StrictFloat, StrictInt]] = None
    error_plaid: Optional[Union[StrictFloat, StrictInt]] = None
    error_institution: Optional[Union[StrictFloat, StrictInt]] = None
    refresh_interval: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["success", "error_plaid", "error_institution", "refresh_interval"]
