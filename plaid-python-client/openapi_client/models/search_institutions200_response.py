...
class SearchInstitutions200Response(BaseModel):
    """
    SearchInstitutions200Response
    """ # noqa: E501
    institutions: Optional[List[SearchInstitutions200ResponseInstitutionsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "institutions": [SearchInstitutions200ResponseInstitutionsInner.from_dict(_item) for _item in obj["institutions"]] if obj.get("institutions") is not None else None,
