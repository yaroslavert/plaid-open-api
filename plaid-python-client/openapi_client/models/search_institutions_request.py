...
class SearchInstitutionsRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["client_id", "secret", "query", "products"]
    ...
    def products_validate_enum(cls, value):
        ...
        for i in value:
            if i not in set(['auth', 'balance', 'identity', 'transactions', 'investments']):
                raise ValueError("each list item must be one of ('auth', 'balance', 'identity', 'transactions', 'investments')")
        return value
